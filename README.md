...
- ***[Automated-MCQ-Generator-Using-Langchain-OpenAI-API](https://github.com/supunlakshan100/Automated-MCQ-Generator-Using-Langchain-OpenAI-API):*** <span style="color:green;">Generative Ai, python, Langchain, OpenAI API, AWS, Streamlit</span>
